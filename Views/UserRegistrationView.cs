...
namespace UserInterface.Views
{
    public class UserRegistrationView:IView
    {
        ...
        public UserRegistrationView(IRegister register, IFieldValidator fieldValidator, int updated)
        {
        ...
        private void RegisterUser()
        {
           string AuthenticationTokenString =  _register.Register(_fieldValidator.FieldArray);
            ...
            Console.WriteLine($" USER Authentication token is {AuthenticationTokenString} ");
