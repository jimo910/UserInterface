...
{
    public class UserUpdateProfileView:IView
    {
        ...
        public UserUpdateProfileView(IRegister register, IFieldValidator fieldValidator, int updated)
        {
        ...
        public void RunView()
        {
         ...
         var UserExist =  context.Users.FirstOrDefault(a => a.AuthenticationToken == Auth); 
                   if (UserExist != null)
                {
        ...
        {
            _register.UserExists(Auth);
           string AuthenticationTokenString =  _register.Register(_fieldValidator.FieldArray);
            CommonOutputFormat.ChangeFontColor(FontTheme.Success);
            Console.WriteLine("You have updated the profile.");
            CommonOutputFormat.ChangeFontColor(FontTheme.Default);
            Console.ReadKey();
        }
        ...
        {
            if (!_fieldValidator.ValidatorDel((int)field, _update, fieldValue,  _fieldValidator.FieldArray, out string invalidMessage))
            {
                CommonOutputFormat.ChangeFontColor(FontTheme.Danger);
