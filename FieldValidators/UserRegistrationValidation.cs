...
namespace UserInterface.FieldValidators
{
    public class UserRegistrationValidator:IFieldValidator
    {
        ...
        public void InitialiseValidatorDelegates()
        {
            ...
            _emailExistsDel = new EmailExistsDel(_register.UserExists);
        ...
        private bool ValidField(int fieldIndex, int update ,string fieldValue, string[] fieldArray, out string fieldInvalidMessage)
        {
